...
<CardGroup cols={2}>
  <Card title="Three.js Example" icon={<img src="/images/threejs-logo.svg"/>} color="#a888ff" href="https://github.com/hyperbeam/threejs-example">
  </Card>
  <Card title="A-Frame Example" icon={<img src="/images/aframe-logo.png"/>} color="#a888ff" href="https://github.com/hyperbeam/aframe-example">
  </Card>
  <Card title="React Three Fiber Example" icon={<img src="/images/react-logo.svg"/>} color="#a888ff" href="https://github.com/hyperbeam/react-three-fiber-example">
  </Card>
  <Card title="Babylon.js Example" icon={<img src="/images/babylonjs-logo.svg"/>} color="#a888ff" href="https://github.com/hyperbeam/babylonjs-example">
  </Card>
</CardGroup>
