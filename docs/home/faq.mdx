...
<AccordionGroup>
    ...
    Yes, you can detect when a user changes the virtual browser URL by using [Hyperbeam’s tab event listener API](/client-sdk/javascript/examples#listen-to-tab-events) available in our Web SDK.
