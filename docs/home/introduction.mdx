...
<CardGroup cols={3}>
  <Card
    ...
    icon="js"
    color="#a888ff"
    href="/client-sdk/javascript"
  ></Card>
  <Card
    title="Unity SDK (WebGL)"
    icon="unity"
    color="#a888ff"
    href="/client-sdk/unity/unity-webgl-sdk"
  ></Card>
  <Card
    title="Unity SDK (Desktop)"
    icon="unity"
    color="#a888ff"
    href="/client-sdk/unity/unity-desktop-sdk"
  ></Card>
</CardGroup>
