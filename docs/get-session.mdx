...
The termination time of the cloud computer session. Formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) (e.g. 2006-01-02T15:04:05Z07:00). null if the session hasn't terminated yet.
