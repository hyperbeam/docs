...
<Param body="profile" type="object">
  ...
  <Expandable>
    <Param body="load" type="string">
      ...
      `session_id`, see [response body](#response)).
    </Param>
...
<Param body="extension" type="object">
  Used to [install custom Chrome extensions.](/guides/install-chrome-extension) (Max Size 1MB).
  <Expandable>
...
<ResponseField name="embed_url" type="string">
  A URL you can load into the [web client](/client-sdk/javascript) on your website
</ResponseField>
